...
--
-- Host: 127.0.0.1
-- Generation Time: 23-Set-2016 às 20:30
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  `descricao_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `valor_banner` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `banner` (`id`, `descricao_banner`, `valor_banner`, `image_banner`, `created_at`, `updated_at`) VALUES
(2, 'Camisetas Esportivas', 'A partir de 6unid. R$35,00', 'banner_sport.jpg', NULL, NULL),
(3, 'Uniformes Profissionais - Sociais', 'A partir de 10unid. R$50,00', 'banner_uni.jpg', NULL, NULL);
...
(16, 'Placa de PVC', 'placas em ta', '2016-07-26 01:37:47', '2016-07-26 01:37:47'),
(17, 'Placa de PVC', 'placas em ta', '2016-07-26 01:37:47', '2016-07-26 01:37:47');
...
('2016_08_31_024300_create_banner', 3);
...
--
-- Extraindo dados da tabela `orcamentorap`
--

INSERT INTO `orcamentorap` (`id`, `nome_cliente`, `email`, `celular`, `nome_prod`, `descricao`, `created_at`, `updated_at`) VALUES
(1, 'Anderson de Oliveira Seixas', 'andersonseixas.xt@gmail.com', 2147483647, 'Produto Desejado', 'Descrição do produto Desejado!!!', '2016-07-21 02:55:17', '2016-07-21 02:55:17'),
(2, 'Géssica Tauane', 'gessica.tauane22@gmail.com', 2147483647, 'produto desejado', 'Descrição do produto aqui....', '2016-07-21 03:09:30', '2016-07-21 03:09:30'),
(3, 'Andreya de Oliveira Lima', 'andreya-lima@hotmail.com', 6999, 'Pedagoria Camisa Branca', 'Gostaria desse modelo para uma turma de 40 Alunos', '2016-07-21 04:12:01', '2016-07-21 04:12:01'),
(4, 'Rodrigo Cunha Seixas', 'rodrigo@mail.com', 699999999, 'Convite Baby Chá 10x10  personalizado com foto', 'Quero 100 unidades de convites nesse estilo. gostaria de saber preço e data de entrega.', '2016-07-21 19:09:27', '2016-07-21 19:09:27'),
(5, 'Anderson de Oliveira Seixas', 'andersonseixas.xt@gmail.com', 2147483647, '  Cód.:17 Convite baby chá 10x10 cm casal na foto', 'convite mudar a cor para rosa', '2016-07-26 01:26:02', '2016-07-26 01:26:02'),
(6, 'Anderson de Oliveira Seixas', 'andersonseixas.xt@gmail.com', 2147483647, '  Cód.:16 Convite Baby Chá 10x10 personalizado com foto', 'Colocar foto modificar no', '2016-07-26 01:33:56', '2016-07-26 01:33:56');
...
(23, 'Pedagoria Branca - Coruja no Galho', 'A partir de 10 unid. R$30,00', 'Camiseta em tecido 100% poliester. Gola branca e mangas barradas\r\nPintura: Frente - cor preta\r\nCosta: Sem pintura\r\n', 'Pedagogia 3.JPG', 'branca_costa.jpg', '', '', 'Camisetas Acadêmicas', '2016-07-21 15:35:43', NULL);
...
(1, 'Anderson Seixas', 'andersonseixas.xt@gmail.com', '$2y$10$05KXwy9Dzl.2m/1.JJ5Uq.SJKjzpdmg2izIZieyuIDpxbkQR8nat.', 'L0cVhZ7IhXcaOmeX2mUvcvxu2tmNDBEZKqr5qTb393lK4LvW0UyozqbMvJvV', '2016-06-30 00:29:38', '2016-07-22 00:47:25'),
