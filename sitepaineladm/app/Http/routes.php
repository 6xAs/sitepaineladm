...
Route::get('/', function () {
  ...
  return view('templatesite.index', compact('produto','categoria','banner'));
...
Route::get('prod/{id}/detalhes', ['as' => 'detalhes', function ($id) {
    ...
    $categoria = \App\categoria::All();
    $banner = \App\Banner::All();
    return view('templatesite.viewProd', compact('produto','categoria', 'banner'));
...
Route::get('contato', function () {
  ...
  $produto = \App\produtos::orderBy('created_at','DESC')->paginate(10);
  $banner = \App\Banner::All();
  return view('site.contato', compact('produto','categoria','baner'));
...
Route::get('sobrenos', function () {
  ...
  $produto = \App\produtos::orderBy('created_at','DESC')->paginate(10);
  $banner = \App\Banner::All();
  return view('templatesite.sobrenos', compact('produto','categoria','banner'));
...
Route::get('orcamento', function () {
  ...
  $produto = \App\produtos::orderBy('created_at','DESC')->paginate(10);
  $banner = \App\Banner::All();
  return view('templatesite.orcamento', compact('produto','categoria','banner'));
...
Route::get('orcamento', function () {
  ...
  $produto = \App\produtos::orderBy('created_at','DESC')->paginate(10);
  $banner = \App\Banner::All();
  return view('site.orcamento', compact('produto','categoria','banner'));
...
// NovoSlider
Route::get('NovoBanner', function() {
  return view('html.NovoBanner');
  //return view('auth.register');
});

// inputSlider
Route::resource('inputSlider','SliderController@inputSlider');

Route::resource('listarbanner','SliderController@listarBanner');

// Edit
Route::resource('banners','SliderController');

//Editar banner
Route::resource('editbanner', 'SliderController@update');

//Deletar banner
Route::resource('deletarbanner', 'SliderController@destroy');
